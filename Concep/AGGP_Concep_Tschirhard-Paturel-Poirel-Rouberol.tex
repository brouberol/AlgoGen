...
Le but de ce projet est de faire évoluer une population de réseaux grâce à un algorithme génétique pré-existant. Nous devons définir une \textit{fitness} qui permet de sélectionner les individus sur leurs capacités à s'approcher d'un réseau biologique. A chaque génération, on vérifiera l'adéquation de chaque réseau avec les caractéristiques suivantes : la loi de distribution des degrés, la propriété de petit monde et la présence de cliques. Ceci permettra de sélectionner les individus qui formeront la génération suivante. Des mutations et des \textbf{crossing-over} apporteront de la nouveauté. Au final, on testera la robustesse des réseaux ainsi que leur concordance avec la disassortativité.
